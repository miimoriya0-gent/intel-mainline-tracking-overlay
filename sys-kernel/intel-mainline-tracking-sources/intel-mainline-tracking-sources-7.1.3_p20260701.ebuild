...
IUSE+="experimental vanilla clang-polly rt-i915 sched-bore"

# CachyOS のパッチベースURL
CACHYOS_COMMIT="c624c9c8cffc11dd619a7d37f903556c60d24e9c"
...
src_prepare() {
	...
	if ! use vanilla; then
		...
		if use sched-bore; then
			...
			rm -f "${WORKDIR}/5020_BMQ-and-PDS-io-scheduler-20260615-v7.1-r1.patch" || die
